/*
    ...
    File name: form_validator.js (Version: 1.6)
...
function Form_Validator(form_id, form_elements)
{
    ...
    if (global_lang === null)
    {
        ...
        alert('Error: Languages Manager extension is not loaded!');
        ...
        for (i = 0; i < form_elements.length; i++)
        {
            ...
            if (this_element.id == 'register_username_text')
            {
                    ...
                    this_element.value.length < 3)
                {
                    ...
                    AJAX_Transfer_Response('/framework/extensions/ajax/forms_manager/form_validator.php', 
    ...
    if (form_id == 'insert_common_form')
    {
        ...
        insert_result = AJAX_Transfer_Response('/cms/site/back_end/php/actions/control/common_insert.php', 
                                               'insert=1&' + 
    ...
    if (form_id == 'update_common_form')
    {
        ...
        update_result = AJAX_Transfer_Response('/cms/site/back_end/php/actions/control/common_update.php', 
                                               'update=1&' + 
    ...
    if (form_id == 'insert_content_form')
    {
        ...
        insert_result = AJAX_Transfer_Response('/cms/site/back_end/php/actions/control/content_insert.php', 
                                               'insert=1&' + 
    ...
    if (form_id == 'update_content_form')
    {
        ...
        update_result = AJAX_Transfer_Response('/cms/site/back_end/php/actions/control/content_update.php', 
                                               'update=1&' + 
    ...
    if (form_id == 'insert_menu_form')
    {
        ...
        insert_result = AJAX_Transfer_Response('/cms/site/back_end/php/actions/control/menu_insert.php', insert_str, 1);
    ...
    if (form_id == 'update_menu_form')
    {
        ...
        update_result = AJAX_Transfer_Response('/cms/site/back_end/php/actions/control/menu_update.php', update_str, 1);
    ...
    if (form_id == 'insert_lang_form')
    {
        ...
        insert_result = AJAX_Transfer_Response('/cms/site/back_end/php/actions/control/lang_insert.php', 
                                               'insert=1&' + 
    ...
    if (form_id == 'update_lang_form')
    {
        ...
        update_result = AJAX_Transfer_Response('/cms/site/back_end/php/actions/control/lang_update.php', 
                                               'update=1&' + 
    ...
    if (form_id == 'update_ext_form')
    {
        ...
        for (i = 4; i < form_elements.length; i++)
            update_str = update_str + form_elements[i];
        
        update_str = update_str + '&global_lang=' + global_lang;
        
        update_result = AJAX_Transfer_Response('/cms/site/back_end/php/actions/control/extension_update.php', update_str, 1);
    ...
    if (form_id == 'insert_user_form')
    {
        ...
        insert_result = AJAX_Transfer_Response('/cms/site/back_end/php/actions/control/user_insert.php', 
                                               'insert=1&' + 
    ...
    if (form_id == 'update_user_form')
    {
        ...
        update_result = AJAX_Transfer_Response('/cms/site/back_end/php/actions/control/user_update.php', 
                                               'update=1&' + 
