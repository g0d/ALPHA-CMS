<?php
    ...
    */
    ...
    class IMAGE extends MULTIMEDIA
    {
        ...
        private static $__alt = null;
        private static $__src = null;
        private static $__width = null;
        private static $__abort = null;
        ...
        public static function Show_Tag($options = null)
        {
            ...
            if ($options === null)
            {
                ...
                if (self::$__alt != '' && self::$__alt !== null)
                    $final_tag .= 'alt="' . self::$__alt . '" ';
                ...
                if (self::$__abort != '' && self::$__abort !== null)
                    $final_tag .= 'onabort="' . self::$__abort . '" ';
            ...
            else
            {
                ...
                if($options['alt'] != '' && $options['alt'] !== null)
                    $final_tag .= 'alt="' . $options['alt'] . '" ';
                ...
                if($options['abort'] != '' && $options['abort'] !== null)
                    $final_tag .= 'onabort="' . $options['abort'] . '" ';
