    ...
    class FIELDSET extends GROUP
    {
        ...
        public static function Show_Tag($content, $options = null)
        {
            ...
            if ($options === null)
            {
                ...
                if (self::$__legend != '' && self::$__legend !== null)
                    $final_tag .= '<legend>' . self::$__legend . '</legend>';

                $final_tag .= $content . '</fieldset>';
            ...
            else
            {
                ...
                if ($options['legend'] != '' && $options['legend'] !== null)
                    $final_tag .= '<legend>' . $options['legend'] . '</legend>';
