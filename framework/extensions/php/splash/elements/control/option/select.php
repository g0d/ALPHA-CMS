<?php
    ...
    */
    ...
    class SELECT extends OPTION
    {
        ...
        private static $__size = null;
        private static $__multiple = false;
        ...
        public static function Show_Tag($content, $options = null)
        {
            ...
            if ($options === null)
            {
                ...
                if (self::$__size != '' && self::$__size !== null)
                    $final_tag .= 'size="' . self::$__size . '" ';
            ...
            else
            {
                ...
                if($options['multiple'] == true || $options['multiple'] == '1')
                    $final_tag .= 'multiple ';
