        ...
        public static function Show_Tag($options = null)
        {
            ...
            if ($options === null)
            {
                ...
                if ((self::$__type == '' || self::$__type === null) ||
                    (self::$__type != 'text' && self::$__type != 'password'))
                {
                ...
                $final_tag = '<input type="' . self::$__type . '" ';
            ...
            else
            {
                ...
                if (($options['type'] == '' || $options['type'] === null) ||
                    ($options['type'] != 'text' && $options['type'] != 'password'))
                {
                ...
                $final_tag = '<input type="' . $options['type'] . '" ';
