    ...
    class LABEL extends TEXT
    {
        ...
        public static function Show_Tag($content, $options = null)
        {
            ...
            if ($options === null)
            {
                ...
                if (self::$__for != '' && self::$__for !== null)
                    $final_tag .= 'for="' . self::$__for . '" ';
            ...
            else
            {
                ...
                if($options['for'] != '' && $options['for'] !== null)
                    $final_tag .= 'for="' . $options['for'] . '" ';
