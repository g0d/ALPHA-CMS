<?php
    ...
    /*
        ...
        localhost Ltd - Show 404
        
        Version: 1.0
        
        File name: show_404.php
        Description: This file contains the Show 404 extension.
        ...
        echo '<html>
                ...
                <body>
                    ...
                    <div class="wrap_404">
                        ...
                        <div class="cont_404">
                            <h1>' . ALPHA_CMS::Load_Content('Oops_label', 'content', $this_lang) . '</h1>

                            <h2>' . ALPHA_CMS::Load_Content('req_page_not_found_label', 'content', $this_lang) . '</h2>

                            <h3>' . ALPHA_CMS::Load_Content('req_page_not_exist_label', 'content', $this_lang) . '</h3>
