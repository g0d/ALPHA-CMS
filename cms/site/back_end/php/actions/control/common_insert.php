<?php
    ...
    /*
        ...
        File name: common_insert.php
        Description: This file contains the AJAX common insert.
    ...
    */
    ...
    if ($_POST['insert'] == 1 && !empty($_POST['site_title']) && 
        !empty($_POST['binded_route']) && !empty($_POST['lang_code']) && !empty($_POST['global_lang']))
    {
        ...
        if ($result === false)
        {
            ...
            echo Error_Reporter('3', $_POST['global_lang']);
